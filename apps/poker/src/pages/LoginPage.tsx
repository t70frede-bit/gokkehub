  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center p-5"
      ...
      <div className="w-full max-w-sm">
        ...
        <Panel>
          <p className="font-semibold text-center mb-5" style={{ color: "rgb(var(--text-primary-rgb))" }}>
            Sign in with your GokkeHub Discord
          </p>
          <Button fullWidth onClick={loginWithDiscord}>
          ...
          <p className="text-center text-xs mt-4" style={{ color: "rgb(var(--text-muted-rgb))" }}>
            Same account as the rest of GokkeHub. Your profile is created automatically the first time.
          </p>
        </Panel>
      </div>
    </div>
